...
We will need to download the RNAseq count table separately. This file was generated by RSEM as part of [Ebegboni et al](https://pubmed.ncbi.nlm.nih.gov/38588446/) and is archived in [GEO](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE243183). In your VS Code terminal, download the counts file, then unzip it.
